...
// GetDictionary provides a mock function with given fields: ctx, langCode
func (_m *mockRepoDictionary) GetDictionary(ctx context.Context, langCode string) ([]DictWord, error) {
