...
import (
	...
	eventsRepository "github.com/av-ugolkov/lingua-evo/internal/services/events/delivery/repository"
	...
	repoNotif "github.com/av-ugolkov/lingua-evo/internal/services/notifications/delivery/repository"
...
func TestReadEvent(t *testing.T) {
	...
	t.Run("read event", func(t *testing.T) {
		err := tr.CreateTransaction(ctx, func(ctx context.Context) error {
			eid, err := eventsSvc.AddEvent(ctx, usr.ID, entity.Payload{
